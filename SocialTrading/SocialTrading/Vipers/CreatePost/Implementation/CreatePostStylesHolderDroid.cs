...
{
    public class CreatePostStylesHolderDroid<T> : ICreatePostStylesHolder where T : AGlobalControlsTheme
    {
        ...
        private string _backButtonTheme               = "CreatePostBackButtonStyle";
