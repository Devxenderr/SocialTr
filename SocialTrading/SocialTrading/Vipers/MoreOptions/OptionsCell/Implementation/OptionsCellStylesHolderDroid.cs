...
{
    public class OptionsCellStylesHolderDroid<T> : IOptionsCellStyleHolder where T : AGlobalControlsTheme
    {
        ...
        public OptionsCellStylesHolderDroid(ThemeParser<T> themeParser)
        {
