...
{
    public class RegPhoneStylesHolderDroid<T> : IRegPhoneStylesHolder where T : AGlobalControlsTheme
    {
        ...
        private string _skipButtonTheme             = "AuthButtonStyle";
        ...
        private string _phoneCountryStateSuccess    = "AuthEditTextSuccessStyle";
        private string _phoneCountryStateFail       = "AuthEditTextFailStyle";
        private string _phoneNumberEditTextTheme    = "AuthEditTextStyle";
        private string _phoneNumberStateSuccess     = "AuthEditTextSuccessStyle";
        private string _phoneNumberStateFail        = "AuthEditTextFailStyle";
        ...
        public RegPhoneStylesHolderDroid(ThemeParser<T> themeParser)
        {
