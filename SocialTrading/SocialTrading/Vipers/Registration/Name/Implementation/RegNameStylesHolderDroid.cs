...
{
    public class RegNameStylesHolderDroid<T> : IRegNameStylesHolder where T : AGlobalControlsTheme
    {
        ...
        private string _nameStateSuccess        = "AuthEditTextSuccessStyle";
        private string _nameStateFail           = "AuthEditTextFailStyle";
        private string _lastNameEditTextTheme   = "AuthEditTextStyle";
        private string _lastNameStateSuccess    = "AuthEditTextSuccessStyle";
        private string _lastNameStateFail       = "AuthEditTextFailStyle";
