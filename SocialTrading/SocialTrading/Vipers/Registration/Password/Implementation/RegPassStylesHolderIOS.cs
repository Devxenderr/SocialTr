...
{
    public class RegPassStylesHolderIOS<T> : IRegPassStylesHolder where T : AGlobalControlsTheme
    {
        ...
        private string _passwordConfirmStateSuccess         = "AuthEditTextSuccessStyleIOS";
        private string _passwordConfirmStatePassNotMatch    = "AuthEditTextFailStyleIOS";
        private string _passwordConfirmStateFail            = "AuthEditTextFailStyleIOS";
        ...
        public RegPassStylesHolderIOS(ThemeParser<T> themeParser)
        {
