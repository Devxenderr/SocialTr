...
{
    public class UpdatePostStylesHolderIOS<T> :  CreatePostStylesHolderIOS<T>, IUpdatePostStylesHolder where T : AGlobalControlsTheme
    {
        ...
        public UpdatePostStylesHolderIOS(ThemeParser<T> themeParser) : base (themeParser)
        {
