...
{
    public class PostHeaderStylesHolderDroid<T> : IPostHeaderStylesHolder where T : AGlobalControlsTheme
    {
        ...
        private string _currentPriceImgUp       = "PostHeaderCurrentPriceImgUpStyle";
        private string _currentPriceImgDown     = "PostHeaderCurrentPriceImgDownStyle";
        ...
        public PostHeaderStylesHolderDroid(ThemeParser<T> themeParser)
        {
